...
\excludeversion{LONG}
\excludeversion{TODO} \excludeversion{JEREMY} \excludeversion{SIMON} \excludeversion{STEFAN} 
...
% \begin{itemize}
% \item 
An example of synergy between compressed data structures and the adaptive analysis of algorithms is the concept of entropy: well known in the field of compressed data structures, it inspired refinements in the analysis of adaptive sorting algorithms \cite{2013-TCS-CompressedRepresentationsOfPermutationsAndApplications-BarbayNavarro}.
%
% \item 
An example of synergy between the adaptive analysis of algorithms and parameterized complexity is how the study of ``Adaptive Sorting'' algorithms has introduced reductions between measures of disorder \cite{1992-ACJ-AnOverviewOfAdaptiveSorting-MoffatPetersson,1995-DAM-AFrameworkForAdaptiveSorting-PeterssonMoffat}, while the study of fixed-parameter tractable problems has introduced the more general \emph{parameterized reductions} between pairs formed by problems and measure~\cite{DowneyF13,CyganFKLMPPS15}. This latest methodology applied to adaptive sorting will bring a better understanding of the input order sensitivity of other problems. We predict that it will inspire the definition of such reductions between pairs formed by \textsc{Abstract Data Types} and measures of compressibility in the study of compressed data structures and of compressed indices.
% \item 
An example of synergy between the adaptive analysis of algorithms and succinct indexes is the application of a measure of difficulty for sorting to the compression of RMQ indices~\cite{2012-TCS-LRMTreesCompressedIndicesAdaptiveSortingAndCompressedPermutations-BarbayFischerNavarro}.
% \end{itemize}

Some examples of similar synergies which have not been explored yet are 
% \begin{itemize}
% \item 
refining the analysis in the worst case of approximation ratios: doing so conditionned to a difficulty measure is prone to yield finer results and a better understanding of the problem to aproximate; and
% \item 
refining the competitive analysis of online algorithms and data structures: for instance, deferred data structures taking advantage of the gaps between queries \cite{2014-WALCOM-DynamicOnlineMultiSelectionInInternalAndExternalMemory-BarbayGuptaJoRaoSorenson,2013-ESA-OnlineRankSelect-BarbayGuptaJoRaoSorenson} can also take advantages of the input order and structure, and of the query order~\cite{2017-CPM-SynergisticSortingAndDeferredDataStructuresOnMultiSets-BarbayOchoaRao,2016-ARXIV-SynergisticSortingAndDeferredDataStructuresOnMultiSets-BarbayOchoaRao}.
% \end{itemize}
...
% \begin{itemize}
%\item 
a compendium of  analysis techniques for both algorithms and data structures;  and
%\item 
a compendium of reductions and of dual results between algorithms and data structures.
% \end{itemize}
...
The outcome is a proceedings of short articles about techniques, and of even shorter articles describing open problems. Each guest will have to submit one, and present it at the workshop.  The interaction time will take the well-established format of open problem sessions, with people taking turn at the boards in 10mns rounds.
