...
\item An example of synergy between the adaptive analysis of algorithms and succinct indexes is the application of a measure of difficulty for sorting to the compression of RMQ indices~\cite{2012-TCS-LRMTreesCompressedIndicesAdaptiveSortingAndCompressedPermutations-BarbayFischerNavarro}.
\end{itemize}

Some examples of similar synergies which have not been explored yet are 
\begin{itemize}
\item refining the analysis in the worst case of approximation ratios: doing so conditionned to a difficulty measure is prone to yield finer results and a better understanding of the problem to aproximate; and
\item refining the competitive analysis of online algorithms and data structures: for instance, deferred data structures taking advantage of the gaps between queries \cite{2014-WALCOM-DynamicOnlineMultiSelectionInInternalAndExternalMemory-BarbayGuptaJoRaoSorenson,2013-ESA-OnlineRankSelect-BarbayGuptaJoRaoSorenson} can also take advantages of the input order and structure, and of the query order~\cite{2017-CPM-SynergisticSortingAndDeferredDataStructuresOnMultiSets-BarbayOchoaRao,2016-ARXIV-SynergisticSortingAndDeferredDataStructuresOnMultiSets-BarbayOchoaRao}.
\end{itemize}
